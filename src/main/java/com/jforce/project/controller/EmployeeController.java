...
import com.jforce.project.model.LoginModel;
import com.jforce.project.model.NewUserModel;
...
public class EmployeeController {
    ...
    */
    ...
    @ResponseStatus(value = HttpStatus.OK)
    @ResponseBody
    public ResponseHolder<CardModel> addDailyWorkCard(@Valid @RequestBody DailyWorkCardModel request)
            throws GenericException {
        logger.info("Add card");
        ResponseHolder<CardModel> response = new ResponseHolder<>();
